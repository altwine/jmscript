...
init_events :: proc(allocator := context.allocator) {
	events = make(map[string]Event, 185, allocator)
	...
	events["experience_orb_merge"] = {"experience_orb_merge", true}
	...
	events["player_prepare_item_craft"] = {"player_prepare_item_craft", false}
